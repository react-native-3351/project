                ...
                {user &&
                    ...
                    && <>
                        <Text style={styles.mainTitle} lightColor={Colors.dark.tint}>
                            Add a question    </Text>
                        <TextInput
                            style={styles.input} lightColor={Colors.dark.tint} onChangeText={text => setQuestion(text)}
                            value={question}
                        />
                        <TextInput
                            style={styles.input} lightColor={Colors.dark.tint} onChangeText={text => setAnswer(text)}
                            value={answer}
                        />{
                            answer!==""&&question!==""&&
                            <Button
