...
export default function ParkingInfo({ sensor }) {
            ...
            <View style={styles.carView}>
                {sensor.spots.map((r, index) => (
                    <React.Fragment key={index}>
                        {r === "" ? (
                            <Text style={{ ...styles.spot, backgroundColor: "green" }}>*</Text>
                        ) : (
                            <Text style={{ ...styles.spot, backgroundColor: "red" }}>
                                {sensor.spots[index]}
                            </Text>
                        )}
                        {index % 2 == 0 && <Text style={styles.street}>|</Text>}
                    </React.Fragment>
                ))}
            </View>
