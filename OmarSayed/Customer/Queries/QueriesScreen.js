  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        {
          tabs === 'Queries' &&
          <UserQueries allQueries={allQueries} setTabs={setTabs} setSelectedSensorId={setSelectedSensorId} />
        }
        {
          tabs === 'Sensor' && 
          <SensorDetails selectedSensorId={selectedSensorId} setSelectedSensorId={setSelectedSensorId} setTabs={setTabs} />
        }
      </ScrollView>
    </SafeAreaView>
  );
