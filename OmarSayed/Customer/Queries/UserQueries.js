...
export default function UserQueries({allQueries, setTabs, setSelectedSensorId}) {
    return (
        allQueries.map(i =>
            <View key={i.id} style={{ borderWidth: 2, padding: 7, margin: 7,alignSelf:'center', width: 500, alignItems: 'center' }}>
                ...
                <TouchableOpacity onPress={() => {
                    ...
                    <Text style={styles.helpLinkText} lightColor={Colors.light.tint}>See Sensor</Text>
                </TouchableOpacity>
            </View>
