                ...
                !descriptionView ?
                    ...
                    <>
                        <View>
                            ...
                            <Text style={{ alignSelf: 'center', padding: 7 }}>{sensor.description}</Text>
                            <Image
                        ...
                        <View style={{ borderColor: 'lightgreen', borderStartWidth: 3, marginTop: 50, padding: 9 }}>
                            <Text style={{ ...styles.title, marginBottom: 30 }}>Any question feel free to ask 😀</Text>
                            <TextInput
                                style={{ height: 40, width: 300, marginBottom: 10, borderColor: 'lightgray', alignSelf: 'center', borderWidth: 1, paddingLeft: 11 }}
