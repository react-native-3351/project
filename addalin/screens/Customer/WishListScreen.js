...
export default function WishListScreen() {
    ...
    return (
        ...
        <View>
            <Button buttonStyle={styles.button} title="Create Wishlist" onPress={() => viewCreate()} />
            <ScrollView>
                <View style={styles.container}>
                        ...
                        {lists.length !== 0 ?
                            lists.map((list) => {
                                return (
                                    <ListItem style={{ width: 250 }} containerStyle={{ backgroundColor: "black" }} key={list.id} bottomDivider>
                                        <ListItem.Content>
                                            <Card>
                                                ...
                                                <View style={{ flexDirection: "row" }}>
                                                    <Button buttonStyle={{backgroundColor:"purple"}} title="View Sensors" onPress={() => toggleOverlay(list.id)} />
                                                    <Button
                                                        type="clear"
                                                        icon={
                                                            <Icon
                            ...
                            <ListItem style={{ width: 350 }} containerStyle={{ backgroundColor: "black" }} key={1}>
                                <ListItem.Content>
                                    <ListItem.Title><Text style={styles.thirdTitle}>You have currently no wishlists !</Text></ListItem.Title>
                                </ListItem.Content>
                            </ListItem>
                        }
                </View>
