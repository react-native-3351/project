...
export default function LightInfo({ sensor }) {
    ...
    return (
        <View style={styles.container}>
            ...
            {reading && <Text style={styles.thirdTitle}>Current: {reading.current}</Text>}
            ...
            <View>
                {sensor && sensor.alert == "high" ? (
                    <Text style={styles.thirdTitle}>Very Bright ! Turning Lights Off...</Text>
                ) : sensor.alert == "equal" ? (
                    <Text style={styles.thirdTitle}>
                        Lights are just right ! Turning Lights Off...
                    </Text>
                ) : (
                    <Text style={styles.thirdTitle}>Lights are Low ! Turning Lights On...</Text>
                )}
            </View>
        </View>
    );
